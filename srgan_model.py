...
class Discriminator(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.leaky_relu(self.bn64(self.conv2(x)))
        x = self.leaky_relu(self.bn128(self.conv3(x)))
        x = self.leaky_relu(self.bn128(self.conv4(x)))
        x = self.leaky_relu(self.bn256(self.conv5(x)))
        x = self.leaky_relu(self.bn256(self.conv6(x)))
        x = self.leaky_relu(self.bn512(self.conv7(x)))
        x = self.leaky_relu(self.bn512(self.conv8(x)))
